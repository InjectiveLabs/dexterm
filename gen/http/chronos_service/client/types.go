...
//
// ChronosService HTTP client types
//
// Command:
...
// SymbolInfoResponseBody is the type of the "ChronosService" service
// "symbolInfo" endpoint HTTP response body.
...
// HistoryResponseBody is the type of the "ChronosService" service "history"
...
// SymbolInfoBadRequestResponseBody is the type of the "ChronosService" service
...
// SymbolInfoNotFoundResponseBody is the type of the "ChronosService" service
...
// SymbolInfoInternalResponseBody is the type of the "ChronosService" service
...
// HistoryBadRequestResponseBody is the type of the "ChronosService" service
...
// HistoryNotFoundResponseBody is the type of the "ChronosService" service
...
// HistoryInternalResponseBody is the type of the "ChronosService" service
...
// NewSymbolInfoResponseOK builds a "ChronosService" service "symbolInfo"
// endpoint result from a HTTP "OK" response.
func NewSymbolInfoResponseOK(body *SymbolInfoResponseBody) *chronosservice.SymbolInfoResponse {
	v := &chronosservice.SymbolInfoResponse{
		S:      *body.S,
		Errmsg: body.Errmsg,
	}
...
// NewSymbolInfoBadRequest builds a ChronosService service symbolInfo endpoint
// bad_request error.
func NewSymbolInfoBadRequest(body *SymbolInfoBadRequestResponseBody) *chronosservice.BaseChronosResponse {
	v := &chronosservice.BaseChronosResponse{
		S:      *body.S,
		Errmsg: body.Errmsg,
	}
	return v
...
// NewSymbolInfoNotFound builds a ChronosService service symbolInfo endpoint
// not_found error.
func NewSymbolInfoNotFound(body *SymbolInfoNotFoundResponseBody) *chronosservice.BaseChronosResponse {
	v := &chronosservice.BaseChronosResponse{
		S:      *body.S,
		Errmsg: body.Errmsg,
	}
...
// NewSymbolInfoInternal builds a ChronosService service symbolInfo endpoint
// internal error.
func NewSymbolInfoInternal(body *SymbolInfoInternalResponseBody) *chronosservice.BaseChronosResponse {
	v := &chronosservice.BaseChronosResponse{
		S:      *body.S,
		Errmsg: body.Errmsg,
	}
...
// NewHistoryResponseOK builds a "ChronosService" service "history" endpoint
// result from a HTTP "OK" response.
func NewHistoryResponseOK(body *HistoryResponseBody) *chronosservice.HistoryResponse {
	v := &chronosservice.HistoryResponse{
		S:      *body.S,
		Errmsg: body.Errmsg,
		Nb:     body.Nb,
	}
...
// NewHistoryBadRequest builds a ChronosService service history endpoint
// bad_request error.
func NewHistoryBadRequest(body *HistoryBadRequestResponseBody) *chronosservice.BaseChronosResponse {
	v := &chronosservice.BaseChronosResponse{
		S:      *body.S,
		Errmsg: body.Errmsg,
	}
...
// NewHistoryNotFound builds a ChronosService service history endpoint
// not_found error.
func NewHistoryNotFound(body *HistoryNotFoundResponseBody) *chronosservice.BaseChronosResponse {
	v := &chronosservice.BaseChronosResponse{
		S:      *body.S,
		Errmsg: body.Errmsg,
	}
...
// NewHistoryInternal builds a ChronosService service history endpoint internal
// error.
func NewHistoryInternal(body *HistoryInternalResponseBody) *chronosservice.BaseChronosResponse {
	v := &chronosservice.BaseChronosResponse{
		S:      *body.S,
		Errmsg: body.Errmsg,
	}
