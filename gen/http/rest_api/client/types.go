...
// NewListDerivativeMarketsRequestBody builds the HTTP request body from the
// payload of the "listDerivativeMarkets" endpoint of the "RestAPI" service.
func NewListDerivativeMarketsRequestBody(p *restapi.ListDerivativeMarketsPayload) *ListDerivativeMarketsRequestBody {
